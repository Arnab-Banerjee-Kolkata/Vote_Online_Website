...
if (empty($_POST["stateid"])) {
    $errorMSG = "<li>State ID is required</<li>";
} else {
    $stateid=$_POST['stateid'];
}

include '../Values.php';
$url=$web_host."/GetPhaseElections.php";

$data = array('postAuthKey' =>$post_auth_key,'adminId' =>$admin_id,'type' =>$type,'stateElectionId' =>$stateid);
$options = array(
    'http' => array(
