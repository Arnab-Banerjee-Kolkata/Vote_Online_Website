...
include '../Values.php';
          ...
          $json_array=json_decode($response, true); 
            if($json_array['success'])
              {
            echo'
             <label for="lsphaseselected" class="my-2">Select Phase:</label> 
            <select class="form-control rounded-pill navshadow border-0" id="lsphaseselected" name="lsphaseselected" required>
